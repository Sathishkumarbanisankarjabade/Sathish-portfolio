...
const skillsData = [
  {
    ...
    color: "#64d9ff",
    position: [3, 0, 0],
    description: "Developing robotics software and middleware for ROS 2-based systems.",
  },
  {
    name: "TurtleBot3",
    category: "Robotics",
    ...
    color: "#ff6fb5",
    position: [2.1, 2.1, 0],
    description: "Building autonomous robot applications and perception modules on TurtleBot3.",
  },
  {
    name: "SLAM & Nav2",
    category: "Navigation",
    ...
    color: "#8a63ff",
    position: [0, 3, 0],
    description: "Implementing mapping, localization, and autonomous navigation stacks.",
  },
  {
    ...
    color: "#45f3ff",
    position: [-2.1, 2.1, 0],
    description: "Simulating robotics systems and testing perception pipelines in Gazebo.",
  },
  {
    name: "YOLOv8",
    category: "Perception",
    ...
    color: "#ffcb45",
    position: [-3, 0, 0],
    description: "Deploying real-time object and QR detection for robotics perception.",
  },
  {
    name: "OpenCV",
    category: "Vision",
    ...
    color: "#3466ff",
    position: [-2.1, -2.1, 0],
    description: "Computer vision pipelines for motion analysis and image-based sensing.",
  },
  {
    name: "Python",
    ...
    color: "#3776ab",
    position: [0, -3, 0],
    description: "Python development for robotics, perception, and automation workflows.",
  },
  {
    name: "Linux Ubuntu",
    category: "Systems",
    ...
    color: "#f37053",
    position: [2.1, -2.1, 0],
    description: "Building and deploying robotics software on Linux Ubuntu systems.",
  },
]
